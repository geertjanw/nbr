...
@OptionsPanelController.SubRegistration(location = "R", id = "RServe",
        displayName = "#AdvancedOption_DisplayName_RServe",
        keywords = "#AdvancedOption_Keywords_RServe",
        keywordsCategory = "R/RServe", position = 50)
public final class RServeOptionsPanelController extends OptionsPanelController {
    ...
    private RServePanel getPanel() {
        if (panel == null) {
            panel = new RServePanel(this);
        }
        return panel;
    }
